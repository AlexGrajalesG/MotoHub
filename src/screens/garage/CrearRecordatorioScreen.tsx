...
const styles = StyleSheet.create({
  ...
  tipoChipActive: { backgroundColor: '#ff6b00', borderColor: '#ff6b00' },
  ...
  avisarChipActive: { backgroundColor: '#ff6b00', borderColor: '#ff6b00' },
  ...
  avisarInputActive: { borderColor: '#ff6b00' },
  button: {
